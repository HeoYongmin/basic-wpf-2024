...
namespace ex10_MovieFinder2024
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private async void SearchMovie(string movieName)
        {
            ...
            foreach (var item in jsonArray)
            {
                var movieItem = new MovieItem()
                {
                    ...
                    // Conver.ToBoolean(object) == Boolean.Parse(string)
                    // Convert.ToDuble() == Double.Parse(string)
        ...
        private async void BtnAddFavorite_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (isFavorite == true) // 즐겨찾기 보기한 뒤 영화를 다시 즐겨찾기 하려고 할 때 막음.
            {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(Helpers.Common.CONNSTRING))
                {
                    ...
                    foreach (MovieItem item in addMovieItems)
                    {
                        ...
                        var cnt = Convert.ToInt32(chkCmd.ExecuteScalar()); // COUNT(*) 등의 1row, 1coloum값을 리턴할 때
